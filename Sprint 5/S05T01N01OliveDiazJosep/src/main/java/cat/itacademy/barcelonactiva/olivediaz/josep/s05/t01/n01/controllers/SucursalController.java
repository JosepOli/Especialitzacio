...
import cat.itacademy.barcelonactiva.olivediaz.josep.s05.t01.n01.model.dto.SucursalDTO;
...
public class SucursalController {
	...
	public String showAllSucursals(Model model) {
		...
		List<SucursalDTO> sucursalDTOs = sucursals.stream().map(this::convertToDto).collect(Collectors.toList());
